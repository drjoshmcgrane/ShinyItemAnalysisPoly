...
```{r IRT-wright-map-plot, eval = show_IRT, echo = FALSE, fig.height = 4.5, fig.width = 11}
...
print(
  ...
  booktabs = T, comment = F, include.rownames = T, sanitize.text.function = function(x) {
    x
  },
